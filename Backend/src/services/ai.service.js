    ...
    properties: {
        ...
        technicalQuestions: {
            ...
            items: {
                type: SchemaType.OBJECT,
                properties: {
                    question: { type: SchemaType.STRING, description: "The technical question that can be asked during the interview" },
                    intention: { type: SchemaType.STRING, description: "The intention of this question being asked" },
        ...
        behavioralQuestions: {
            ...
            items: {
                type: SchemaType.OBJECT,
                properties: {
                    question: { type: SchemaType.STRING, description: "The behavioral question that can be asked during the interview" },
                    intention: { type: SchemaType.STRING, description: "The intention of this question being asked" },
                    answer: { type: SchemaType.STRING, description: "How to answer this question" }
                },
                required: ["question", "intention", "answer"]
        ...
        skillGaps: {
            ...
            items: {
                type: SchemaType.OBJECT,
                properties: {
                    skill: { type: SchemaType.STRING, description: "Mention the skill gap" },
                    // Notice how we handle the enum here
                    severity: { type: SchemaType.STRING, description: "MUST BE EXACTLY ONE OF: 'low', 'medium', 'high'" }
                },
        ...
        preparationPlan: {
            ...
            items: {
                ...
                properties: {
                    ...
                    focus: { type: SchemaType.STRING, description: "Focus area for the day" },
                    tasks: {
                        type: SchemaType.ARRAY,
